...
from .views import SensorDataViewSet, UserViewSet, logout_view, me_view, SiloViewSet, TelemetryViewSet, FarmViewSet, LoteViewSet, SecadorViewSet, ProcessoViewSet, ClienteViewSet, chat_view
